...
const navItems = [
  ...
  { href: "/newsletters", label: "Browse Newsletters", icon: Search },
  { href: "/sponsor/campaigns", label: "My Campaigns", icon: Calendar },
  { href: "/sponsor/billing", label: "Billing", icon: FileText },
  { href: "/sponsor/profile", label: "Profile", icon: User },
];

export function SponsorDashboardLayout({
  children,
}: {
